  ...
  render: function() {
    ...
    return (
      <div>
        <Headroom wrapperStyle={{ marginBottom: rhythm(1) }}>
          <Container style={{ maxWidth: null, padding: '16px 20px' }}>
            <Flex align="center" col="3" justify="space-between">
              <Box>
                <Flex>
                  <Box px={1}>
                    <a
                      target="_blank"
                      href="https://twitter.com/sderosiaux"
              ...
              {pathname !== '/' && (
                <Box px={1} className="index">
                  Check out my{' '}
                  <Link to={prefixLink('/')}>
                    <span className="nice-btn">Latest articles</span>
                  </Link>
                </Box>
              )}
        ...
        <Container style={{ maxWidth: 1024 }}>{this.props.children}</Container>
